    ...
    public class WebScrapingService : IWebScrapingService
    {
        public List<ProductScrapingModel> GetProductsInfo()
        {
            ...
            htmls.ForEach(html =>
            {
                ...
                var notCompleteNode = doc.DocumentNode.SelectNodes("//div[@id='warning_not_complete']");

                if (notCompleteNode != null)
                    return;
        ...
        public List<ProductScrapingModel> GetOneProductInfo()
        {
            HtmlWeb web = new HtmlWeb();
            HtmlDocument doc = web.Load("https://world.openfoodfacts.org");

            var htmlNode = doc.DocumentNode.SelectNodes("//ul[@class='products']/li/a[@title!='']");

            var html = htmlNode[0].GetAttributeValue("href", null);
        ...
        public List<ProductScrapingModel> GetProductsInfoScheduled()
        {
            HtmlWeb web = new HtmlWeb();
            HtmlDocument doc = web.Load("https://world.openfoodfacts.org");
